...
const useStyles = makeStyles((theme) => ({
  ...
  submit: {
    "&.MuiButton-root": {
      ...
      backgroundColor: "rgb(101, 23, 171)",
      borderRadius: " 30px",
    },
...
const UserSchema = Yup.object().shape({
	...
	email: Yup.string().email("E-mail inválido").required("Por favor, preencha esse campo!"),
	phone: Yup.string().min(8, "Muito curto!").max(12, "Muito Longo!"),
});
    ...
    <div className="geral-signup">
      <div className={"container-signup"}>
        <div className={"paper"}>
          ...
          <div>
            <span className="span">
              👋🏻 Comece seu <b>teste GRATUITO</b> de 3 dias do OrionChat em
              apenas 3 etapas!{" "}
                ...
                <Grid>
                  <Grid item>
                    <Link
                      ...
                      to="/login"
                      style={{ color: "#6517AB", fontWeight: 500 }}
                    >
