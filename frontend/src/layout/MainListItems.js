...
const MainListItems = (props) => {
  ...
  const [versaoDoSistema] = useState("V 1.9");
        ...
        no={() => (
          ...
          >
            ...
            <>
              ...
              {/* Inicio do codigo para liberar menu de campanha e arquivo ao perfil user */}
            ...
            <ListItemLink
              ...
              icon={<AttachFile />}
            />
            {/* Fim  do codigo para liberar menu de campanha e arquivo ao perfil user */}
            </>
          </>
        )}
      />
